              ...
              <div className="col-4">
                <div className="row d-flex justify-content-end px-3">
                  ...
                  <div className="d-flex flex-column plus-minus">
                    ...
                    */}
                  <button className=" btn btn-info btn-outline-dark "><i className="fa fa-minus"></i></button>
                  <p className="btn mb-0" id="cnt2">
                    1
                  </p>
                  <button className="btn btn-info btn-outline-dark"><i className="fa fa-plus"></i></button>
                </div>
              </div>
              <div className="col-4">
          ...
          <div className="my-auto col-7">
            <div className="row text-right">
              ...
              {/*  <div className="row d-flex justify-content-end px-3">
                  ...
                  <div className="d-flex flex-column plus-minus">
                    {" "}
                    <span className="vsm-text plus si">+</span>{" "}
                    <span className="vsm-text minus">-</span>{" "}
                  </div>
                </div> */}
                <div className="row d-flex justify-content-end px-3 ">
